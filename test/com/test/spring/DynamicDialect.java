...
public class DynamicDialect extends Dialect {
	...
	private final static String hibernateDataSource = PropsUtil.get(BeanFactoryAglocoProcessor.STRING_HIBERNATE_DATA_SOURCE);
	...
	public DynamicDialect() {
		...
		try {
			con = DataAccess
					.getConnection(com.liferay.portal.util.Constants.DATA_SOURCE);
		} catch (Exception e) {
		...
		try {
			if (con == null) {
				DataSource ds = (DataSource) BeanFactoryAglocoProcessor
						.getBeanFactory().getBean(hibernateDataSource);
	...
	public String getAddForeignKeyConstraintString(String constraintName,
		...
		return _dialect.getAddForeignKeyConstraintString(constraintName,
